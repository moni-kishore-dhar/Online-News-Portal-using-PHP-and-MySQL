...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/Online News Portal/Admin/AdminBangladeshPage.php">Bangladesh</a>
                    </li>
                    <li class="nav-item">
  ...
  <div class="container" style="margin-top: 40px; width: 60%;">
    ...
    <?php
      date_default_timezone_set("Asia/Dhaka");
      $Date=date("d/m/Y");
      $sql = "SELECT * FROM news WHERE NewsDate='$Date' and NewsCategory='Bangladesh' order by NewsTimeForSort desc";
      $result = mysqli_query($conn, $sql);
