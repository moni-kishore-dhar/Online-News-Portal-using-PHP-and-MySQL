...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active" href="/Online News Portal/Admin/AdminBusinessPage.php">Business</a>
                    </li>
                    <li class="nav-item">
  ...
  <div class="container" style="margin-top: 40px; width: 60%;">
    ...
    <?php
      date_default_timezone_set("Asia/Dhaka");
      $Date=date("d/m/Y");
      $sql = "SELECT * FROM news WHERE NewsDate='$Date' and NewsCategory='Business' order by NewsTimeForSort desc";
      $result = mysqli_query($conn, $sql);
