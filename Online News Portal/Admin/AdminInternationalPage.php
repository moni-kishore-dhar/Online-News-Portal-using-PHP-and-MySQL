...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/Online News Portal/Admin/AdminInternationalPage.php">International</a>
                    </li>
                     <li class="nav-item">
                ...
                <button class="btn btn-outline-dark my-2 my-sm-0" type="submit" style="margin-left: 15px;">Sign Up</button>
                </div>
  ...
  <div class="container bg-light" style="border: 1px black solid; margin-top: 30px; width: 20%;">
    <center><h5><a class="nav-link" href="/Online News Portal/News Management (Admin)/AddNews.php"><b>Add News</b></a></h5></center>
  </div>
  ...
  <div class="container" style="margin-top: 40px; width: 60%;">
    ...
    <?php
      date_default_timezone_set("Asia/Dhaka");
      $Date=date("d/m/Y");
      $sql = "SELECT * FROM news WHERE NewsDate='$Date' and NewsCategory='International' order by NewsTimeForSort desc";
      $result = mysqli_query($conn, $sql);
              ...
              <div class="row">
                <div class="col-md-3">
                  <?php
                    if (isset($NewsImage)) {
                  ?>
                      <a href="/Online News Portal/Admin/AdminSinglePageNewsViewModule.php?var=<?php echo $NewsId;?>"><img src="/Online News Portal/Images/<?php echo$NewsImage ?>"  alt="Image is not available"  style=" width: 100%; height: 200px;"></a>
                  <?php
                      unset($NewsImage);
                    }
                  ?>
                ...
                <div class="col-md-8 bg-white" style="margin-left: 1px;">
                  <a class="nav-link" href="/Online News Portal/Admin/AdminSinglePageNewsViewModule.php?var=<?php echo $NewsId;?>" style="padding-left: 0px;">
