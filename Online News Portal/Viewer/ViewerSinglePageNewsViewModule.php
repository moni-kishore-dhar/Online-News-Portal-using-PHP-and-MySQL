...
<body>
  ...
  <div class="container" style="margin-top: 50px;">
    ...
    <div class="container bg-light" style="width: 40%; padding-top: 10px; padding-bottom: 10px; font-size: 15px;">
      <form action="/Online News Portal/Viewer/ConnectViewerAddComments.php?var=<?php echo $NewsId;?>" method="Post">
        <div class="row">
          <div class="col-md-10">
            <textarea name="CommentsDescription" placeholder="Write a comment..." required style="height: 40px; width: 100%; border-radius: 10px; padding-left: 15px;"></textarea>         
          </div>
          <div class="col-md-2" style="padding-left: 0px;">
            <button class="btn btn-outline-dark" type="submit" style="width: 100%; border-radius: 10px;">Post</button>
          </div>
        </div>
      </form>       
    </div>
    <div class="container bg-light overflow-auto" style="width: 40%; padding-top: 20px; padding-bottom: 20px; font-size: 20px; min-height: 50px; max-height: 800px; margin-bottom: 40px;">
        ...
        <div class="container bg-white overflow-auto" style="text-align: left; border-radius:20px; padding-top: 10px; padding-bottom: 10px; font-size: 15px; padding-left: 25px;">          
            ...
            <?php
              if ($ViewerId==$CommentatorsId) {
            ?>
                <div class="col-md-4" style="text-align: right; padding-right: 30px;">              
                    <a href="/Online News Portal/Viewer/ConnectViewerDeleteComments.php?CommentsId=<?php echo $CommentsId;?> & NewsId=<?php echo $NewsId;?>" class="nav-link"><font color="DimGray">Delete</font></a>
                </div>
            <?php
              }    
            ?>                
