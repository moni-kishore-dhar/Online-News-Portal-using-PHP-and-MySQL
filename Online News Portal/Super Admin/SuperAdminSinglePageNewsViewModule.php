    ...
    <div class="dropdown" style="position: absolute; right: 15%; margin-top: 25px;">
        <button class="btn" type="button" data-toggle="dropdown"><img src="/Online News Portal/Images/EditIcon.PNG" alt="Image is not available" style="height: 25px; width: 25px;"></button>
            <ul class="dropdown-menu" style="text-align: center;">
                <li><a href="/Online News Portal/News Management (Super Admin)/SuperAdminUpdateNews.php?var=<?php echo $NewsId;?>" class="nav-link">Update News</a></li>
                <li><a href="/Online News Portal/News Management (Super Admin)/SuperAdminUpdateImages.php?var=<?php echo $NewsId;?>" class="nav-link">Update Picture</a></li>
                <li><a href="/Online News Portal/News Management (Super Admin)/ConnectSuperAdminDeleteNews.php?var=<?php echo $NewsId;?>" class="nav-link">Delete News</a></li>
                <li><a href="/Online News Portal/News Management (Super Admin)/ConnectSuperAdminDeleteImages.php?var=<?php echo $NewsId;?>" class="nav-link">Delete Picture</a></li>
            </ul>
    </div>
        ...
        <div class="container bg-white overflow-auto" style="text-align: left; border-radius:20px; padding-top: 10px; padding-bottom: 10px; font-size: 15px; padding-left: 25px;">          
              ...
              <div class="row" style="font-size: 12px; color: dimgray; font-weight: bold;">
                ...
                <div class="col-md-4" style="text-align: right; padding-right: 30px;">              
                    <a href="/Online News Portal/Super Admin/ConnectSuperAdminDeleteComments.php?CommentsId=<?php echo $CommentsId;?> & NewsId=<?php echo $NewsId;?>" class="nav-link"><font color="DimGray">Delete</font></a>
                </div>                
              </div>                            
        </div><br>
        </center>
