...
?>
  ...
  <div class="container" style="margin-top: 50px;">
    ...
    <div class="SignUpBox container" style="width: 30%; border: 2px solid black;">
        ...
        <br>
            <center><h4>Administrator</h4></center><br>
            <center><h5>Sign In</h5></center>
            <br>  
            <form action="/Online News Portal/Super Admin/ConnectSuperAdminSignIn.php" method="Post" style="font-weight: bold;">
                Email<br>
                <input name="SuperAdminEmail" placeholder="@email.com" type="email" required><br><br>
                Password<br>
                <input name="SuperAdminPassword" placeholder="At least 6 characters" minlength="6" type="password" required><br><br>
