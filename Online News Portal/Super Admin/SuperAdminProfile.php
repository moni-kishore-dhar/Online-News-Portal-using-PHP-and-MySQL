...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
     ...
     <?php
      ...
      if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
          $SuperAdminFirstName=$row["SuperAdminFirstName"];
          $SuperAdminLastName=$row["SuperAdminLastName"];
  ...
  <div class="container bg-light" style="width: 30%; margin-top: 70px; margin-bottom: 60px; border: 2px black solid; text-align: center; font-size: 25px; font-weight: bold;"><br>
    <?php 
          echo $SuperAdminFirstName."   ".$SuperAdminLastName."<br>";
    ...
    <div class="row" style="font-size: 15px; font-weight: bold;">
      <div class="col-md-6">
        <button class="btn btn-outline-dark" style="border: none;" type="submit" data-toggle="modal" data-target="#SuperAdminEditNameModal"><b>Edit Name</b></button>      
      </div>
      <div class="col-md-6">
        <button class="btn btn-outline-dark" style="border: none;" type="submit" data-toggle="modal" data-target="#SuperAdminEditPasswordModal"><b>Edit Password</b></button>         
      </div>
  ...
  <br>
        ...
        <!--Edit Name Modal -->
        <div class="modal fade" id="SuperAdminEditNameModal">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="container" style="width: 80%;">
                          ...
                          <form action="/Online News Portal/Super Admin/ConnectEditSuperAdminProfile.php" method="Post">
                            <br>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <input name="SuperAdminFirstName" type="text"  style="width: 100%;" required value="<?php echo $SuperAdminFirstName; ?>"> 
                              </div>  
                            </div><br>
                            <div class="row">
                              <div class="col-md-6" style="text-align: right; padding-right: 0px;">
                              ...
                              <div class="col-md-6">
                                <input name="SuperAdminLastName" type="text" style="width: 100%;" required value="<?php echo $SuperAdminLastName; ?>">
                              </div>  
                            </div>
                            <br>                              
                            <center>
        ...
        <!--Edit Password Modal -->
        <div class="modal fade" id="SuperAdminEditPasswordModal">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="container" style="width: 80%;">
                          ...
                          <form action="/Online News Portal/Super Admin/ConnectEditSuperAdminProfile.php" method="Post">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <input name="SuperAdminOldPassword" type="password" required style="width: 100%;"> 
                              </div>  
                            </div><br>
                            <div class="row">
                              <div class="col-md-6" style="text-align: right; padding-right: 0px;">
                              ...
                              <div class="col-md-6">
                                <input name="SuperAdminNewPassword" type="password" required minlength="6" placeholder="At least 6 characters" style="width: 100%;">
                              </div>  
                            </div>
                            <br>                              
                            <center>
