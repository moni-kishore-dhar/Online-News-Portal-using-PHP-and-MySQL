...
<body>
  ...
  <div class="container" style="margin-top: 50px;">
    ...
    <form action="/Online News Portal/News Management (Admin)/ConnectAddNews.php" method="Post">
      <center>
        ...
        <table width="80%;" border="1px"; cellpadding="0px";>
          ...
          <tr>
            <td><textarea name="NewsHeadline" style="height: 220px; width: 100%;" required></textarea></td>
          </tr>
        </table>
        ...
        <table width="80%;" border="1px"; cellpadding="0px";>
          ...
          <tr>
            <td><textarea name="NewsDescription" style="height: 1000px; width: 100%;" required></textarea></td>
          </tr>
        </table>
        <br>
